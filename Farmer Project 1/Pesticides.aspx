<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Pesticides.aspx.cs" Inherits="Farmer_Project_1.Pesticides" %>
            ...
            <div class="container py-5">
                <div class="row justify-content-start">
                    <div class="col-lg-8 text-center text-lg-start">
                        ...
                        <a href="Index.aspx" class="btn btn-primary py-md-3 px-md-5 me-3">Home</a>
                        <a href="Product.aspx" class="btn btn-secondary py-md-3 px-md-5">Products</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="row g-0">
                            ...
                            <div class="col-10">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [name], [price], [image] FROM [Add_product] WHERE ([type] = @type)">
                                    <selectparameters>
                                        <asp:Parameter DefaultValue="Pesticides" Name="type" Type="String" />
                                    </selectparameters>
                                </asp:SqlDataSource>
                            </div>
