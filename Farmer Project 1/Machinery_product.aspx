<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Machinery_product.aspx.cs" Inherits="Farmer_Project_1.Machinery_product" %>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-10">
                                    <asp:DataList ID="DataList2" runat="server" DataSourceID="SqlDataSource2" RepeatColumns="4" RepeatDirection="Horizontal">
                                        <ItemTemplate>
                                            <a href="Product_content.aspx?name=<%# Eval("name") %>"><div class="position-relative m-4">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [name], [price], [image] FROM [Add_product] WHERE ([type] = @type)">
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="Machinery" Name="type" Type="String" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    <br />
                                    <br />
