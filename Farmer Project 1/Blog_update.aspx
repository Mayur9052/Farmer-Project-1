<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Blog_update.aspx.cs" Inherits="Farmer_Project_1.Blog_update" %>
<asp:Content ID="Content4" runat="server" contentplaceholderid="ContentPlaceHolder2">
    ...
    <!-- Navbar End -->
                ...
                <!-- Comment Form Start -->
                <div class="bg-primary p-5" style="margin:40px 200px;">
                    <h2 class="text-white mb-4">Blog Update</h2>
