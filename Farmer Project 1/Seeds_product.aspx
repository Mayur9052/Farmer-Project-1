<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Seeds_product.aspx.cs" Inherits="Farmer_Project_1.Seeds_product" %>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-10">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [name], [price], [image] FROM [Add_product] WHERE ([type] = @type)">
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="Seeds" Name="type" Type="String" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
